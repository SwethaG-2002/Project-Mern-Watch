    ...
    return(
      ...
      <div className="row contactus">
        ...
        <div className="col-md-6">
          ...
          <p className="text1">
          <p>Welcome to LUNA TIMES, where time meets style and sophistication. At LUNA TIMES, we're passionate about watches, 
          and our mission is to bring you the finest timepieces from around the world, curated with precision and care.</p><br></br>
          
          <p>Established with a vision to redefine the way you perceive watches, LUNA TIMES is more than just a marketplace;
          ...
          and attention to detail.Thank you for considering LUNA TIMES for your timepiece needs. We're honored to be a part of your journey through time. </p>
          </p>
